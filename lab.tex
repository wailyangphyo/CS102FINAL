...
This lab explores use of APIs to get a if matching the ueser's keyboard
entered in a GUI textbox. 
Our GUI will allow users to search for gifs with a keyword.
}
\normalpage{Analysis}{%
